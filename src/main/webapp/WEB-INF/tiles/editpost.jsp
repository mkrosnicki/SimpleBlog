...
<div class="col-md-6">
    <div class="well" id="addpost">
        <div>
            ...
            <center><h4>Edytuj treść posta</h4></center>
            <hr />
            <form:form modelAttribute="post" method="POST" cssClass="form-horizontal">
                ...
                <br />
                <input type="submit" class="btn btn-success" style="width: 100%" value="Edytuj" />
